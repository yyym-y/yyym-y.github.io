...
cover : "/assets/cover/"
previousUrl : ""
nextUrl : "/2024/04/25/java-basic-questions-02/"
---
* awsl
{:toc}
...
**<mark>本系列搬运自 <a href="https://javaguide.cn/">JavaGuide</a>, 本人根据自身理解加上批注转载于此, 欢迎各位去原网站支持作者</mark>**
...
![运行在 Java 虚拟机之上的编程语言](/assets/images/JavaGuide/java-virtual-machine-program-language-os.png)
...
![](/assets/images/JavaGuide/JavaSeSpecifications.jpg)
...
![JDK 包含 JRE](/assets/images/JavaGuide/jdk-include-jre.png)
...
![Java程序转变为机器代码的过程](/assets/images/JavaGuide/java-code-to-machine-code.png)
...
![Java程序转变为机器代码的过程](/assets/images/JavaGuide/java-code-to-machine-code-with-jit.png)

> HotSpot 采用了惰性评估(Lazy Evaluation)的做法，根据二八定律，消耗大部分系统资源的只有那一小部分的代码（热点代码），而这也就是 JIT 所需要编译的部分。JVM 会根据代码每次被执行的情况收集信息并相应地做出一些优化，因此执行的次数越多，它的速度就越快。

JDK、JRE、JVM、JIT 这四者的关系如下图所示。

![JDK、JRE、JVM、JIT 这四者的关系](/assets/images/JavaGuide/jdk-jre-jvm-jit.png)

下面这张图是 JVM 的大致结构模型。

![JVM 的大致结构模型](/assets/images/JavaGuide/jvm-rough-structure-model.png)
...
![编译型语言和解释型语言](/assets/images/JavaGuide/compiled-and-interpreted-languages.png)
...
![JIT vs AOT](/assets/images/JavaGuide/jit-vs-aot.png)
...
![oracle jdk release cadence](/assets/images/JavaGuide/oracle-jdk-release-cadence.jpg)
...
![Java 注释类型总结](/assets/images/JavaGuide/java-annotation-types.png)
...
![](/assets/images/JavaGuide/image-20220714112336911.png)
...
![Java 移位运算符总结](/assets/images/JavaGuide/shift-operator.png)
...
![基本类型 vs 包装类型](/assets/images/JavaGuide/primitive-type-vs-packaging-type.png)
...
![](/assets/images/JavaGuide/up-1ae0425ce8646adfb768b5374951eeb820d.png)
...
![成员变量 vs 局部变量](/assets/images/JavaGuide/member-var-vs-local-var.png)
